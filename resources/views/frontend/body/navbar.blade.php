...
<div class="navbar-area">
    ...
    <div class="mobile-nav">
        <a href="/" class="logo">
            <img src="{{ asset('upload/Logo/'.$setting->logo)}}" class="logo-one" alt="Logo">
            <img src="{{ asset('upload/Logo/'.$setting->logo)}}" class="logo-two" alt="Logo">
        </a>
    </div>
            ...
            <nav class="navbar navbar-expand-md navbar-light ">
                ...
                <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                    <ul class="navbar-nav m-auto">
                        ...
                        <li class="nav-item">
                            <a href="{{route('frontend.all.rooms')}}" class="nav-link">
                                All Rooms
