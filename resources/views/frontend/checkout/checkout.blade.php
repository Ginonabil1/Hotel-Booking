...
<section class="checkout-area pt-100 pb-70">
    <div class="container">
        <form role="form" method="post" action="{{ route('checkout.store') }}" class="stripe_form require-validation" data-cc-on-file="false" data-stripe-publishable-key="{{ env('STRIPE_KEY') }}">
            @csrf
            <div class="row">
                <div class="col-lg-8">
                        ...
                        <div class="card-body">
                              <div class="billing-details">
                                    ...
                                    <div style="display: flex">
                                          <img style="height:100px; width:120px;object-fit: cover" src="{{ (!empty($room->image))? url('upload/room/'.$room->image):url('upload/no_image.jpg') }}" alt="Images" alt="Images">
                                          <div style="padding-left: 10px;">
                                                <a href="{{route('search_room_details',$room->id)}}" style="font-size: 20px; color: #595959;font-weight: bold">{{ @$room->type->name}}</a>
                                                <p><b>{{$room->price}}</b></p>
                                          </div>
                ...
                <div class="col-lg-8 col-md-8">
                    <div class="payment-box">
                        ...
                        <button type="submit" class="order-btn border-0" id="myButton">Place to Order</button>
                    </div>
                </div>
            </div>
        </form>
