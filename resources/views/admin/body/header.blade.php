        ...
        <nav class="navbar navbar-expand gap-3">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a href="javascript:;">
                                <div class="msg-header">
                                    ...
                                    <p class="msg-header-badge" id="notification-count">{{ $ncount }} New</p>
                                </div>
                            </a>
            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ (!empty($profile->photo)? url('upload/admin_images/'.$profile->photo ) : url('upload/no_image.jpg'))}}" class="user-img" alt="user avatar">
                    <div class="user-info">
                        <p class="user-name mb-0">{{$profile->name}}</p>
                        <p class="designattion mb-0">{{$profile->email}}</p>
                    </div>
                </a>
