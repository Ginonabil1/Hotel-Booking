					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="{{route('all.testimonial')}}"><i class="bx bx-home-alt"></i></a>
								</li>
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <img id="showImage" src="{{ url('upload/Testimonial/'.$testimonial->image) }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="80">
                    </div>
                </div>
