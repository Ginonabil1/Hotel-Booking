        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="form-group col-sm-9 text-secondary">
                        <textarea class="form-control" id="description" name="description" rows="3" placeholder="Description">{{$book->description}}</textarea>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="form-group col-sm-9 text-secondary">
                        <input type="text" name="link"  class="form-control" value="{{$book->link}}"  />
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <img id="showImage" src="{{url('upload/BookArea/'.$book->image)}}" alt="pic" class="rounded-circle p-1 bg-primary" width="80">
                    </div>
                </div>
