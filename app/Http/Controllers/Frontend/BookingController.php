...
class BookingController extends Controller
{
    public function BookingSearch(Request $request){
        ...
        if ($request->check_in == $request->check_out or $request->check_in > $request->check_out) {
    ...
    public function BookingRoomDetails(Request $request , $id){
        $request->flash();   // save the requested data to display with old('') to url
        ...
        return view('frontend.room.search_room_details' , compact('room' , 'images' ,'facilities' , 'recommend_rooms' , 'room_id'));
    }
    ...
    public function CheckRoomAvailability(Request $request){
        ...
        $bookings = Bookings::withCount('assign_rooms')->whereIn('id',$check_date_booking_ids)->where('rooms_id',$room->id)->get()->toArray();

        $total_book_room = array_sum(array_column($bookings,'assign_rooms_count'));

        $av_room = @$room->room_numbers_count-$total_book_room;  //@$room @ to avoid the error of invalid rooms
    ...
    public function CheckoutStore(Request $request){
        ...
        $this->validate($request,[
            ...
            $data->persons = $book_data['persons'];
    ...
    public function BookingList(){
        ...
        return view('backend.booking.booking_list', compact('data'));
    }

    public function EditBooking($id){
        $booked = Bookings::with('room')->find($id);
        return view('backend.booking.edit_booking', compact('booked'));
    }
    ...
    public function BookingUpdateDate(Request $request, $id){
     ...
     public function AssignRoom($booking_id){
        ...
        $booking_ids = Bookings::whereIn('id',$check_date_booking_ids)->pluck('id')->toArray();
    ...
    public function AssignRoomDelete($id){
        ...
        $assign_room = BookingRoomList::where('booking_id' , $id);
        $assign_room->delete();

        $booked = Bookings::find($id);
        $booked->delete();

        $room_booked_date = RoomBookedDate::where('booking_id' , $id);
        $room_booked_date->delete();
    ...
    public function DownloadInvoice($id){
        ...
        $editData = Bookings::with('room')->find($id);
    ...
    public function UserBooking(){
        $id = Auth::user()->id;
        $allData = Bookings::where('user_id',$id)->orderBy('id','desc')->get();
