...
class RoomListController extends Controller
{
    public function ViewRoomList(){
        $room_number_list = RoomNumber::with(['room_type','last_booking.booking:id,check_in,check_out,status,code,name,phone'])->orderBy('roomtype_id','asc')
        ...
        ->select(
           ...
           'room_numbers.status as nb_status',
           'room_types.name',
    ...
    public function StoreRoomList(Request $request){
        ...
        $data->persons = $request->number_of_person;
